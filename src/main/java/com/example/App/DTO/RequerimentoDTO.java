...
public class RequerimentoDTO {
    ...
    public RequerimentoDTO(int id_requerimeinto, String titulo, String descripcion, int state, Date fecha_creacion, String comentaio_rector, String comentario_logistico, String comentario_compra, int opcion_elegida, int id_usuario, String tipo_requerimineto) {
